...
def TaskExe():
    ...
    def OpenApps():
        ...
        if 'code' in query:
            os.startfile("C:\\Program Files\\Microsoft VS Code\\Microsoft VS Code\\Code.exe")
    ...
    def Reader():
        ...
        if 'Bangladesh' in name:

            os.startfile('E:\\books\\hi.pdf')
            book = open('E:\\books\\hi.pdf','rb')
            ...
            if 'bengali' in lang:
                transl = Translator()
                textBen = transl.translate(text,'hi')
                textm = textBen.text
